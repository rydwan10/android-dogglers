...
class DogCardAdapter(
    ...
    private var dataSource = DataSource.dogs
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        var adapterLayout: View = LayoutInflater.from(parent.context).inflate(R.layout.vertical_horizontal_list_item, parent, false)
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogAge.text = item.name
        // TODO: Set the text for the current dog's hobbies by passing the hobbies to the
        //  R.string.dog_hobbies string constant.
        //  Passing an argument to the string resource looks like:
        //  resources?.getString(R.string.dog_hobbies, dog.hobbies)
        val dogHobbies = context?.resources?.getString(R.string.dog_hobbies, item.hobbies)
        holder.dogHobbies.text = dogHobbies
